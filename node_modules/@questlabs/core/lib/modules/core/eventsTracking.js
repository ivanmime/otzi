...
class QuestEvents {
    ...
    track(_a, options_1) {
        return __awaiter(this, arguments, void 0, function* ({ entityId, name, userId, properties, isIndependent, isQuestUser, queue }, options) {
            try {
                ...
                const data = {
                    ...
                    name, // it could be eventName if isIndependent is false, else counterName
                    source: "sdk",
                    properties,
                    isIndependent,
